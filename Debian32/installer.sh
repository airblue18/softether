...
#Latest Softether Server Version for May 2018 v4.27-9668-beta-2018.05.26-tree
#Coded by AIRBLUE
...
tar zxf softether-vpnserver-v4.27-9668-beta-2018.05.29-linux-arm_eabi-32bit.tar.gz
cd vpnserver
...
rm -rf softether-vpnserver-v4.27-9668-beta-2018.05.29-linux-arm_eabi-32bit.tar.gz
cd /usr/local/vpnserver
chmod 600 *
chmod 700 vpncmd
chmod 700 vpnserver
#Installing server command
wget https://raw.githubusercontent.com/airblue18/softether/master/Debin32/vpn-server.sh --no-check-certificate
...
echo "SoftEther auto installer by AIRBLUE"
